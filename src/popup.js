function main() {
    ...
    document.getElementById("shareLink").addEventListener("click", () => {
        ...
        copyFrom.textContent =
            "https://github.com/xxxbrian/UNSW-Moodle-Assistant";
    ...
    document.getElementById("sourceCode").addEventListener("click", () => {
        chrome.tabs.create({
            url: "https://github.com/xxxbrian/UNSW-Moodle-Assistant"
        });
    });
...
function requestFeedback() {
    chrome.storage.sync.get(["downloads", "alreadyRequested"], result => {
        ...
        //if (result.downloads >= 50 && result.alreadyRequested == false && localStorage.getItem('fb_switch')!=null ){ // localStorage.serItem('fb_switch',any)打开该功能，localStorage.removeItem('fb_switch')恢复关闭。
        if (1==1){    
